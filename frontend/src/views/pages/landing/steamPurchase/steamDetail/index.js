...
import {
  SteamNameCode,
  SteambuttonData,
} from "../../../../../ui-component/landing/Data/SteamPurchaseData";
import {
  steamLogintitle,
  steamFindLogin,
  steamFindLoginTxt,
      ...
      <Grid container spacing={1}>
        <Grid item lg={7.6} md={7.5} xs={12}>
          {skeltonStatus ? (
            ...
            >
              <Typography sx={{ ...steamLogintitle }}>
                1. Enter your Steam login
              </Typography>
                ...
                >
                  <FormControl fullWidth>
                    ...
                    <Grid
                      ...
                      onClick={handleClick}
                      sx={{
                        // width: { xl: "50%",lg:"62%", md: "65%", sm: "50%", xs: "48%" },
                        ...steamFindLogin,
                      }}
                    >
                      <Typography
                  ...
                  <Snackbar
                    ...
                    message={
                      <Box sx={{ display: "flex" }}>
                        ...
                        <Typography sx={{ pl: 1 }}>
                          С таким именем логин не найден
                        </Typography>
                      </Box>
                    }
                  />
                  ...
                  <Grid item sm={2} xs={4}>
                    <Button
                      ...
                      style={{
                        ...
                        background:
                          index === select ? "rgba(0, 238, 52, 0.1)" : "",
                        border:
                          index === select
                            ? "1px solid rgba(56, 253, 99, 0.3)"
                            : "1px solid #5B6479",
              ...
              <FormControlLabel
                ...
                label={
                  ...
                  >
                    Я подтверждаю, что указал Steam login, а не никнейм
                  </Typography>
                }
              />
            </Card>
